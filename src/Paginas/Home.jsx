...
function Home() {
    ...
    return (
        <div className='p-8 max-w-11xl my-0 mx-auto'>
            ...
            <h1 className='pt-4 text-xl bold text-center my-16 mx-0 text-black dark:text-white'>Filmes Populares</h1>

            <ul className='list-none grid gap-y-16 gap-x-12 grid-cols-[repeat(auto-fit,minmax(280px,1fr))]'>
                {movies.map(movie => {
                    return (
                        <li className='flex flex-col rounded-xl pt-8 items-center hover:shadow-2xl hover:rounded-xl transition duration-300 dark:hover:shadow-3xl dark:hover:shadow-slate-100' key={movie.id}>
